...
namespace SerapisDoctor.Controls.Calendar
{
    public partial class Calendar
    {
        ...
        List<Xamarin.Forms.View> normalView { get; set; }
        ...
        public void PrevMonthYearView()
        {
            if (normalView == null)
            {
                ...
                normalView = new List<Xamarin.Forms.View>();
                w = Content.Width / ShowNumOfMonths;
                h = Content.Height / ShowNumOfMonths;
            ...
            {
                case DateTypeEnum.Normal: ShowYears();
                    break;

                case DateTypeEnum.Month:ShowNormal();
                    break;

                case DateTypeEnum.Year: ShowMonths();
                    break;
