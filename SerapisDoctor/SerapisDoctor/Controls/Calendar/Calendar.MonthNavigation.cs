...
namespace SerapisDoctor.Controls.Calendar
{
    public partial class Calendar : ContentView
    {
        ...
        public static readonly BindableProperty TitleLabelTextProprty =
            BindableProperty.Create(nameof(TitleLabelText), typeof(String), typeof(Calendar), default(String),
                propertyChanged: (bindable, oldValue, newValue) =>
                 {
                     (bindable as Calendar).TitleLabel.Text = (String)newValue;
                 });
        ...
        public static readonly BindableProperty TitleLabelFontSizeProperty =
            BindableProperty.Create(nameof(TitleLabelFontSize), typeof(Double), typeof(Calendar), default(Double), 
                propertyChanged: (bindable, newValue, oldValue) => 
                {
        ...
        public static readonly BindableProperty TitelLeftArrowTextProperty =
            BindableProperty.Create(nameof(TitleLeftArrowText), typeof(String), typeof(Calendar), default(String), 
                propertyChanged: (bindable, oldeValue, newValue) => 
                {
                    (bindable as Calendar).TitleLeftArrow.Text = (String)newValue;
                });
